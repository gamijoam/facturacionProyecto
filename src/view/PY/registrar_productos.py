...
"")
    ...
    def retranslateUi(self, Registrar_productos):
        ...
        self.comboBox.setItemText(0, QCoreApplication.translate("Registrar_productos", u"Carnicos", None))
        self.comboBox.setItemText(1, QCoreApplication.translate("Registrar_productos", u"Bebidas", None))

        self.comboBox_2.setItemText(0, QCoreApplication.translate("Registrar_productos", u"Fernandez", None))
        self.comboBox_2.setItemText(1, QCoreApplication.translate("Registrar_productos", u"Saleciana", None))
